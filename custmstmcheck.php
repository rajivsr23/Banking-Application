...
<body>
	...
	<?php 
		...
		$frmamount=$_POST['min'];
		$toamount=$_POST['max'];
		$query="SELECT * FROM transaction where Account_Number=$account AND Date_Transact>='$frmdate'  AND Date_Transact<='$todate' AND Amount>='$frmamount' AND Amount<='$toamount'";
