...
<head>
	...
	<script type="text/javascript" src="js/delcust.js"></script>
...
<body>
	...
	<form  method="post" name="delcustomer" action="delcustcheck.php" onsubmit="return Validate()">
		<table width="200">
			<tr>
				<td><div class="message">*</div>Customer ID:</td>
				<td><input type="number" name="id" ></td>
				<td><label class="message" id="message">
			</tr>
