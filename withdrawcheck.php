...
<body>
	...
	<?php 
		...
		$number=$_POST['number']; //Account
		$amount=$_POST['amount']; //Amount
		$id=$_POST['id'];//Customer ID
		$descript=$_POST['descript'];
		$query="Update account set Balance=Balance-'$amount' where Account_Number='$number' OR Cust_ID='$id'";
		$query2="Insert into transaction(Amount,Type,Account_Number,Date_Transact,Description) values('$amount','Withdrawal','$number',Now(),'$descript')";
